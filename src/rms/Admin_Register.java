...
public class Admin_Register {
    ...
    public Scene Admin_Register(){
        ...
        //Label
        lbl_register = new Label("Admin Register"); 
        ...
        //adding and aligning
        btn_to_admin.setLayoutX(386);
        btn_to_admin.setLayoutY(329);
        // 
        btn_register.setLayoutX(179);
        btn_register.setLayoutY(329);
        //Label        
        lbl_register.setLayoutX(190);
        ...
        root.getChildren().addAll(left_pane,btn_to_admin,btn_register,lbl_register,lbl_name,lbl_phone,lbl_gender,lbl_password,tx_name, tx_phone,tx_gender,ps_password);
        ...
        //
        AnchorPane.setRightAnchor( btn_to_admin, 58.0);
        //
        ...
        //back
        btn_to_admin.setOnAction((ActionEvent e) -> {
    ...
    public void registerAdmin(){
        ...
        //getText
        String Aname= tx_name.getText();
        String Aphone= tx_phone.getText();
        String Agender= tx_gender.getText();
        String Apass= ps_password.getText();
        // write query 
        String insertquery1 = "INSERT into tbl_admin(adminName,adminPhone,adminGender,adminPassword) values ('";
        String insertquery2 = Aname + "','" + Aphone + "','" + Agender + "','" + Apass + "')" ;
    ...
    //to avoid redundant admin names    
    public boolean isPresent(){
        ...
        //query statement
        String query = "SELECT * FROM tbl_admin WHERE adminName= '" + Aname + "'"; 
        //executing statement
        try{
            Statement statement = conn.createStatement();
